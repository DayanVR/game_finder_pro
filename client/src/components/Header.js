      ...
      <div className="justify-between max-lg:space-y-5 lg:mt-6 lg:flex lg:flex-row-reverse">
        <div className="w-fit max-lg:mx-auto">
          <Link to="/games-library">
            <label className="flex w-fit cursor-pointer items-center space-x-2 py-2 px-3 lg:max-2xl:px-1 rounded-md hover:bg-slate-800/[0.8] ">
              <FontAwesomeIcon
        ...
        <form
          ...
          className="mx-lg:md:justify-center w- sm:w-7/12 max-lg:mx-auto max-md:space-y-4 md:flex md:w-8/12 md:items-center"
        >
